...
// Routes
router.post("/", authMiddleware, adminMiddleware, upload.array("images", 5), createPackage);
router.put("/:id", authMiddleware, adminMiddleware, upload.array("images", 5), updatePackage);
